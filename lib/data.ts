export const team = [
  {
    ...
    bio: 'Sophie steers the strategy and keeps every story on-brand, on-brief, and on time — the connective tissue between the client\u2019s goals and the studio\u2019s ideas.',
  ...
  },
  {
    ...
    slug: 'max',
    image: '/team/max.jpg',
    bio: 'Max shoots and cuts the motion work — from punchy social edits to full campaign films — with an eye for pacing that keeps thumbs from scrolling past.',
  ...
  },
  {
    ...
    bio: 'Haywood builds the visual systems — identity, layout, motion graphics — that make every deliverable unmistakably the client\u2019s own.',
    color: 'sand' as const,
  },
];
