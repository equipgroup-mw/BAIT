...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: '2026',
    slug: 'mibawa-tv',
    image: '/work/thumbs/mibawa.webp',
    thumbnail: '/work/thumbs/mibawa.webp',
    videoUrl: '/work/videos/mibawa.webm', // Added video path
    summary: 'Documentary-style photo and video coverage across a nationwide cooperative network, cut into a single coherent story.',
    url: 'https://github.com/your-org/mibawa-tv',
    platform: 'Marketing Strategy',
    size: 'wide',
    accent: 'sand',
  },
  {
    ...
    year: '2026',
    slug: 'beins-inc',
    image: '/work/thumbs/beins.webp',
    thumbnail: '/work/thumbs/beins.webp',
    videoUrl: '/work/videos/beins.webm', // Added video path
    summary: 'Documentary-style photo and video coverage across a nationwide cooperative network, cut into a single coherent story.',
    url: 'https://github.com/your-org/beins-inc',
    platform: 'Brand Campaign',
    size: 'tall',
    accent: 'sand',
  },
  {
    title: 'SYNERGY: 265PITCH',
    category: 'Marketing Strategy',
    year: '2026',
    slug: 'synergy-265pitch',
    image: '/work/thumbs/synergy.webp',
    thumbnail: '/work/thumbs/synergy.webp',
    videoUrl: '/work/videos/synergy.webm', // Added video path
    summary: 'Documentary-style photo and video coverage across a nationwide cooperative network, cut into a single coherent story.',
    url: 'https://github.com/your-org/synergy-265pitch',
    platform: 'Marketing Strategy',
    size: 'wide',
    accent: 'sand',
  },
